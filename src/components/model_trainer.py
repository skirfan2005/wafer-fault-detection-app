...
# Removed GradientBoostingClassifier to force High-Recall models
...
class ModelTrainer:
    def __init__(self):
        ...
        # High Recall Models Configuration
        self.models = {
    ...
    def finetune_best_model(self, best_model_object:object, best_model_name, X_train, y_train) -> object:
        try:
            ...
            # FIX: Changed n_jobs=-1 to n_jobs=1 to prevent Windows Memory/Pickling Error
            grid_search = GridSearchCV(
                best_model_object, 
                param_grid=model_param_grid, 
                cv=5, 
                n_jobs=1,  # <--- CRITICAL FIX HERE
                verbose=1
            )
